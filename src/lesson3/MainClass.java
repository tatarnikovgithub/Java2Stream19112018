...
public class MainClass {
    public static void main(String[] args) {
      HashMap<String, Integer> uWords1 = new UniqueWords<>(Arrays.asList(
          "Азъ", "Буки", "Веди", "Глаголь", "Добро",
          "Есть", "Живет", "Зело", "Земля", "Иже",
          "Азъ", "буки", "Веди", "глаголь", "Добро"
      )).getUniqueWords();
      System.out.println(uWords1);

      UniqueWords<String> uWords2 = new UniqueWords();
      uWords2.setWords(Arrays.asList(
          "Один", "1", "Два", "два", "Три", "Три", "3"
      ));
